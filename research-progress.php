...
<body class="bg-gradient-lighter">
    <div class="wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="schedule.php"><i
                                    class="ni ni-calendar-grid-58 text-purple"></i>Schedule</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Checklist.php"><i
                                    class="ni ni-bullet-list-67 text text-green"></i>Checklist</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="notes.php"><i
                                    class="ni ni-ruler-pencil text-yellow"></i>Notes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Research-Progress.php"><i
                                    class="ni ni-cloud-upload-96 text-orange"></i>Research Progress</a>
                        </li>
                        <li class="nav-item">
        ...
        <body class="bg-gradient-lighter">
                ...
                <nav class="navbar bg-white shadow navbar-vertical fixed-left navbar-expand-md navbar-light">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="overview.php"><i
                                            class="ni ni-tv-2 text-teal"></i>Overview</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="schedule.php"><i
                                            class="ni ni-calendar-grid-58 text-purple"></i>Schedule</a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="upload.php"><i
                                            class="ni ni-cloud-upload-96 text-pink"></i>Upload Report</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="main-content">
                    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                        <div class="container-fluid">
                            ...
                            <form action="assets/api/logout_user.php">
                                <input type="submit" class="btn" onclick="" value="Logout">
                            </form>
                    ...
                    <div class="header container-fluid bg-gradient-light pb-8 pt-5 pt-md-8">
                        <button type="button" class="btn btn-block btn-default"
                            @click="$modal.show('researchForm');">Add Research</button>
                    </div>
                    <!--===== Page content =====-->
                                ...
                                <tr v-for="research in researches">
                                        ...
                                        <div class="media align-items-center">
                                            <a href="#" class="avatar rounded-circle mr-3" data-toggle="tooltip"
                                                ...
                                                <img alt="Image placeholder"
                                                    :src="'https://api.adorable.io/avatars/256/' + i"
                                    ...
                                    <td>
                                        <div class="avatar-group">
                                            <a href="#" class="avatar avatar-sm" data-toggle="tooltip"
                                                data-placement="top" data-original-title="i"
                                                v-for='i in parseInt(research.contributers)'>
                                                <img alt="Image placeholder"
                                                    :src="'https://api.adorable.io/avatars/256/' + i"
                                                    class="rounded-circle">
                                            </a>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="progress">
                                                    <div :class="'progress-bar ' + statusColor(research.status)"
                                                        role="progressbar" :aria-valuenow="research.completion"
                                                        aria-valuemin="0" aria-valuemax="100"
                                                        :style="'width:'+ research.completion + '%'"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                        <div class="dropdown">
                                            <a class="btn btn-info tdropdown-toggle" href="#" role="button"
                    ...
                    <form role="form" style="height: 400px; padding:0 20px" method="POST" action="#" v-on:submit.prevent="onSubmit">
                        <div class="form-group mb-3">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Research Name" type="text" v-model='name'
                                    name="research-name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Budget" type="number" v-model='budget'
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Contributers" type="text"
                                    v-model='contributers' name="research-contributers" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group input-group-alternative">
                                ...
                                <input class="form-control" placeholder="Completion" type="number" min="0" max="100"
                                    v-model="completion" name="research-completionPercentage" required>
                            </div>
                        </div>

                        <div class="text-center">

                            <button type="input" v-show="mode == 'save'" class="btn btn-primary my-4"
                                @click="add(name,budget,contributers,status,completion)" name="submit-add-research">Add</button>
                            <button type="button" v-show="mode == 'edit'" class="btn btn-primary my-4"
                                @click="update(name,budget,contributers,status,completion)">Edit</button>
            ...
            <script src="researchProgress.js"></script>
